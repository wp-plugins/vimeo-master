...
//MULTISITE TABLE
if (is_multisite()){
if(!class_exists('vimeo_master_admin_updater_multisite')){
	require_once( dirname( __FILE__ ) . '/vimeo-master-admin-updater-multisite-table.php');
}
//Prepare Table of elements
$wp_list_table = new vimeo_master_admin_updater_multisite_table();
//Table of elements
...
if( is_multisite() ) {
add_action( 'network_admin_menu', 'menu_single_vimeo_admin_updater' );
