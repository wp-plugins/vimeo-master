...
class vimeo_master_admin_shortcodes_table_in extends WP_List_Table {
	/**
...
<table class="widefat fixed" cellspacing="0">
	<thead>
		<tr>
			<th id="columnname" class="manage-column column-columnname" scope="col" width="600"><legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Individual Shortcodes', 'vimeo_master'); ?></h3></legend></th>
...
<p>The Individual Shortcode allows you to have a different, customized shortcodes per page or post, you can configure it when editing a post or page. The Universal Shortcode configurable below, allows you to have the same shortcode in all pages and posts by adding <b>[vimeo-master-un]</b> into the text.</p>
